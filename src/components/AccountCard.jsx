...
import { FaEye, FaEyeSlash, FaTrash, FaCopy, FaPen } from 'react-icons/fa'; // FaPen import kiya
import { getBrandStyle } from '../utils/getBrandStyle';
import toast from 'react-hot-toast';

const AccountCard = ({ account, onDelete, onEdit }) => { // onEdit prop receive kiya
  ...
  return (
    <motion.div
      ...
      className={`relative p-5 rounded-2xl border ${style.border} ${style.bg} hover:border-opacity-50 transition-all duration-300 group`}
    >
